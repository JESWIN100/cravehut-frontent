...
const Navbar = () => {
  ...
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: <Home size={20} />, path: '/restaurants/dashboard' },
    {
      id: 'products',
      label: 'Products',
        ...
        >
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Resturent Panel</h1>
            </div>
            <button
              onClick={() => setMobileMenuOpen(false)}
